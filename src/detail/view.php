        ...
        <div id="allContainer">
            ...
            <div class="rectangle-infos">
                <?php foreach ($data as $colismvm) : ?>
                    ...
                    <p>Problèmes rencontrés : <?php echo htmlspecialchars($colismvm['problemes']); ?></p>
                    ...
                    <?php if ($_SESSION['user']['role_user'] === 'Agent de coordination') : ?>
                        <div id="boutons">
                            ...
                            <form id="modify" action="../../utils/formulaires/delete_mvmt.php" method="POST">
                                <button type="submit" id="supprimer" name="id_colis" value="<?php echo $colismvm['id_colis']; ?>">Supprimer</button>
                            </form>
                        </div>
                    <?php endif; ?>
                </div>
